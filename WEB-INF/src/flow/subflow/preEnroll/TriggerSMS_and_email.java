...
public class TriggerSMS_and_email extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("preEnroll-BAU", "Default");
		next.setDebugId(36);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_LATER_SMS_EMAIL_SENT" + "|";
		
		CallHistory.put("VC_MENU_DESCRIPTION", MenuDescription);
		}
		catch(Exception e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivr enrollment later status for SMS - 'ENF'  \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
		}
