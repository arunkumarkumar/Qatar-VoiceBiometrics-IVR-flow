 ...
 */
public class EnrollmentFailureStatusUpdate extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2023-DEC-22  12:37:17 PM
	 */
	public EnrollmentFailureStatusUpdate() {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("preEnroll-updateIVRDb", "Default");
		next.setDebugId(45);
		return next;
	}
	/**
	...
	mySession.setProperty("VB_ENROLL_STATUS",GlobalConstant.LATER);
	...
	MenuDescription += "VB_ENROLLMENT_ENROLL_LATER_STATUS_UPDATE" + "|";
	...
	customerDetails.put(GlobalConstant.VB_Status, "RJ");
	...
	customerDetails.put(GlobalConstant.VB_enrollment_status, "Enroll Reject on IVR");
	...
	TraceInfo.trace(ITraceInfo.TRACE_LEVEL_DEBUG, "customerDetails from IVR after preenroll : "+customerDetails.toString(),mySession);

	}
	catch(Exception e) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivr enrollment later status update in customer details \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	}
