 ...
 * Last generated by Orchestration Designer at: 2023-DEC-22  12:41:37 PM
 */
public class disclaimermenuupdate extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("preEnroll-updateIVRDBforMAXTRIES", "Default");
		next.setDebugId(70);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.setProperty("VB_ENROLL_STATUS","ENROLL_MAXTRIES");
		...
		MenuDescription += "VB_ENROLLMENT_RETRY_MAXTRIES" + "|";
		...
		if("true".equalsIgnoreCase(mySession.getVariableField(IProjectVariables.CONNECTBACK).getStringValue()))//check if this is a transfer CAll
		{
			if( vbstatus == null || "NA".equalsIgnoreCase(vbstatus) || "null".equalsIgnoreCase(vbstatus)) {
				customerDetails.put(GlobalConstant.VB_enrollment_status,"Enroll Maxtries on Agent Assisted");
			}else if("Enroll Rejected on IVR".equalsIgnoreCase(vbstatus)) {
				customerDetails.put(GlobalConstant.VB_enrollment_status,"Enroll Maxtries on IVR and Agent Assisted");
			...
			customerDetails.put(GlobalConstant.VB_enrollment_status,"Enroll Maxtries on IVR");
		...
		mySession.getVariableField(IProjectVariables.VBREASON).setValue("MAXTRIES AT THE ENROLLMENT MENU");
