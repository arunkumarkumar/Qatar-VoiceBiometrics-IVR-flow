 ...
 */
public class enrollmenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("EnrollNow", "1", true, "exact", "preEnroll-Enroll", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("EnrollLater", "2", true, "exact", "preEnroll-enrolllaterannouncement", grammarInfo, true);
		list.add(choice);
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_MENU" + "|";
		CallHistory.put("VC_EXIT_LOCATION", "ENROLL_MENU");
