...
public class checkRejectDays extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "vbstatuscode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "ELG", false).setDebugId(77)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("selfserve-enroll", "Eligible").setDebugId(78));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("selfserve-callmethod", "NotEligible").setDebugId(80));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
