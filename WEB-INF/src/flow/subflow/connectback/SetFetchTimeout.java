 ...
 * Last generated by Orchestration Designer at: 2022-MAR-25  08:01:10 PM
 */
public class SetFetchTimeout extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("connectback-settingDisconnect");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-29  10:24:21 AM
	 */
...
public void updateProperties(Collection properties, SCESession mySession) {
	...
	String timeout = mySession.getVariableField(IProjectVariables.TIMEOUT).getStringValue();
	TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"\t|\t timeout obtained as   \t|\t"+ timeout,mySession);
	if("NA".equalsIgnoreCase(timeout)||"".equalsIgnoreCase(timeout)||timeout==null) {
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"\t|\t fetchtimeout is not set   \t|\t",mySession);
	}
	else {
		property = new com.avaya.sce.runtime.Property("fetchtimeout", (timeout+"s"));
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"\t|\t fetchtimeout set as   \t|\t"+ timeout,mySession);
