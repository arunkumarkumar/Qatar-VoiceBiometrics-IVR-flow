 ...
 * Last generated by Orchestration Designer at: 2024-MAR-13  05:17:35 PM
 */
public class trans extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("fetchaudio", "Transitional");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiodelay", "1s");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiominimum", "2s");
		list.add(property);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("connectback-preProcessor");
		return submit;
	}
	/**
