 ...
 * Last generated by Orchestration Designer at: 2024-MAR-13  05:19:07 PM
 */
public class resettrans_2 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("fetchaudiodelay", "50s");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("fetchaudiominimum", "0s");
		list.add(property);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("connectback-test");
		return submit;
	}
	/**
