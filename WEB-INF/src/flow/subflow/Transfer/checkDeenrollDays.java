...
public class checkDeenrollDays extends com.avaya.sce.runtime.Data {
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "vbstatuscode", com.avaya.sce.runtime.Expression.STRING_EQUAL_IGNORE, "ELG", false).setDebugId(106)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Transfer-vbeligibleannounce", "Eligible").setDebugId(107));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("Transfer-getTransferVDN", "NotEligible").setDebugId(109));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
	...
	static void deenroll_2(String input, String dayscount,SCESession mySession) {
		try
		{
		...
		System.out.println("seconds difference: " + seconds);
			...
			System.out.println("Exception "+GetStackTrace.getMessage(e));
		}
	}
	
	public static void main(String[] args) {
		
		String input = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()).toString();
		long DenrollDays = 3;
		SCESession mySession = null;
		deenroll_2(input, "3", mySession);
		
//		System.err.println("dateformat :"+detectDateFormat(input));
	}
