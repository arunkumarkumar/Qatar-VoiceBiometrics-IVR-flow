...
public class vbAuthenticate extends com.avaya.sce.runtime.Data {
	...
	public void requestBegin(SCESession mySession) {
		...
		String[] fileName = mySession.getVariableField(IProjectVariables.AUTHENTICATE_VOICE_PC, IProjectVariables.AUTHENTICATE_VOICE_PC_FIELD_VALUE).getStringValue().split("/");
...
//			System.out.println("Audio File Path: "+mySession.getAbsoluteTempDirPath().concat("/").concat(file.getName()));
			...
			if(object.getJSONObject("soap:Envelope").getJSONObject("soap:Body").has("VerifyResponse")) {
				...
				//mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!verifyOutput  ::::   ::::::" + VerifyResult.getString("Decision"), mySession);

				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!Decision  :::: " + VerifyResult.get("Decision"));
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!DecisionReason  :::: " + VerifyResult.get("DecisionReason"));
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!RequestId  :::: " + VerifyResult.get("RequestId"));
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!SpeakerId  :::: " + VerifyResult.get("SpeakerId"));
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "!!!!!!AudioSegmentId  :::: " + VerifyResult.get("AudioSegmentId"));
				...
				//need to check for which response we've to set as match in preverify
				...
				if (decision.equalsIgnoreCase("Match")) {
				...
				else if (decision.equalsIgnoreCase("VoiceprintMismatch")) {
					mySession.getVariableField(IProjectVariables.AUTHENTICATE_WS, IProjectVariables.AUTHENTICATE_WS_FIELD_IS_MATCH).setValue(true);
				}else if ( decision.equalsIgnoreCase("PlaybackIndication") ||
					...
					mySession.getVariableField(IProjectVariables.AUTHENTICATE_WS, IProjectVariables.AUTHENTICATE_WS_FIELD_IS_VOICE_MISMATCH).setValue(true);
					/*if (decisionReason.equalsIgnoreCase("VoiceprintMismatch")) {
						mySession.getVariableField(IProjectVariables.AUTHENTICATE_WS, IProjectVariables.AUTHENTICATE_WS_FIELD_IS_VOICE_MISMATCH).setValue(true);
					} else { 
						mySession.getVariableField(IProjectVariables.AUTHENTICATE_WS, IProjectVariables.AUTHENTICATE_WS_FIELD_IS_VOICE_MISMATCH).setValue(true);
					}*/
...
////					String reason = GlobalConstant.getAuthenticateResponseShortCode(decisionReason);
////					mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "**** decisionReason Short Code: " + reason);
...
////				}
				...
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "Received Failure Response From Nuance");
				if(object.getJSONObject("soap:Envelope").getJSONObject("soap:Body").has("soap:Fault")) {
					...
					mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_INFO, "Failure Response: " + text.getString("content"));
			...
			mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_ERROR, "!!!!!!IOException ::: " + e);
			/**IO Exception occurs when no .wav will be present(generated) inside the /temp folder | when caller dosen't prompt any voice to authenticate (noInput) **/
			/**Consider this exception has no input**/
			/**Assign Exception has 'false' and give him the next try if max tries not exceeded **/
			mySession.getVariableField(IProjectVariables.AUTHENTICATE_WS, IProjectVariables.AUTHENTICATE_WS_FIELD_EXCEPTION).setValue(false);
...
////		HostDBLogging.updateDB(exceptionFlag, "Verify", strDate, endDate, mySession);
...
//	}
	...
	public boolean executeDataActions(com.avaya.sce.runtimecommon.SCESession mySession) throws Exception {
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition1", "AuthenticateWS:exception", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(220)).evaluate(mySession)) {
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.Next("preverify-verifyfailureannounce", "hostDownRexception").setDebugId(221));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition2", "AuthenticateWS:isLocked", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(222)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Voice Print has been Locked", "").setDebugId(223));
			actions.add(new com.avaya.sce.runtime.Next("preverify-verifycount", "voicePrintLocked").setDebugId(224));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition3", "AuthenticateWS:isMatch", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(225)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AuthenticateWS:isMatch", "false", true).setDebugId(226));
			actions.add(new com.avaya.sce.runtime.Next("preverify-verifycount", "Authenticated").setDebugId(228));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
		...
		if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition4", "AuthenticateWS:isVoiceMismatch", com.avaya.sce.runtime.Expression.IS_TRUE).setDebugId(398)).evaluate(mySession)) {
			actions = new java.util.ArrayList(2);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AuthenticateWS:isMatch", "false", true).setDebugId(400));
			actions.add(new com.avaya.sce.runtime.Next("preverify-menunameverify", "False").setDebugId(399));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;
			...
			actions = new java.util.ArrayList(1);
			actions.add(new com.avaya.sce.runtime.varoperations.Assign("AuthenticateWS:isVoiceMismatch", "false", true).setDebugId(230));
			if(evaluateActions(actions, mySession)) {
				return true;
			}
			actions = null;

			if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition5", "AuthenticateWS:authenticateCount", com.avaya.sce.runtime.Expression.INT_LESS_THAN, "3", false).setDebugId(231)).evaluate(mySession)) {
				actions = new java.util.ArrayList(2);
				actions.add(new com.avaya.sce.runtime.varoperations.Increment("AuthenticateWS:authenticateCount").setDebugId(232));
				actions.add(new com.avaya.sce.runtime.Next("preverify-verifycount", "retryAuthen").setDebugId(233));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;
				...
				actions = new java.util.ArrayList(1);
				actions.add(new com.avaya.sce.runtime.varoperations.Assign("vbContextStore:vbStatus", "Failure", true).setDebugId(235));
				if(evaluateActions(actions, mySession)) {
					return true;
				}
				actions = null;

				if(((com.avaya.sce.runtime.Condition)new com.avaya.sce.runtime.Condition("condition6", "AuthenticateWS:inconclusiveCount", com.avaya.sce.runtime.Expression.INT_EQUAL, "3", false).setDebugId(236)).evaluate(mySession)) {
					actions = new java.util.ArrayList(2);
					actions.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "Inconclusive count is 3 | transferring the call main IVR to authentiate using other authentication factor", "").setDebugId(237));
					actions.add(new com.avaya.sce.runtime.Next("preverify-verifycount", "inConclusive").setDebugId(238));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
					...
					actions = new java.util.ArrayList(1);
					actions.add(new com.avaya.sce.runtime.Next("preverify-verifycount", "maxtryExceeded").setDebugId(240));
					if(evaluateActions(actions, mySession)) {
						return true;
					}
					actions = null;
