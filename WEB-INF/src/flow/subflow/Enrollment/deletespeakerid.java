 ...
 */
public class deletespeakerid extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-deletevoiceprint", "Default");
		next.setDebugId(128);
		return next;
	}
	/**
...
//        if("undefined".equalsIgnoreCase(mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_UCID).getStringValue())) {
//            mySession.getVariableField(IProjectVariables.SESSION, IProjectVariables.SESSION_FIELD_UCID).setValue("0000" + new SimpleDateFormat(GlobalConstants.DDMMYYYYHHMMSSSS).format(new Date()));
//        }
		
        /**Invoke DBController and load in project variable**/
        //DBController dbCont = (DBController) SpringApplicationContext.getBean("DBController");
        //mySession.getVariableField(IProjectVariables.VB_INPUTS, IProjectVariables.VB_INPUTS_FIELD_DB_CONTROLLER_OBJECT).setValue(dbCont);
		...
		try {
			...
			String method = LoadApplicationProperties.getProperty("DeleteSpeaker", mySession);
...
//			if(responseCode == null || !responseCode.equalsIgnoreCase("200") || responseCode.isEmpty()) {
...
//            StartSessionResult = object.getJSONObject("soap:Envelope").getJSONObject("soap:Body").getJSONObject("DeleteSpeakerResponse");
//			}else {
//				TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO, " does not have Envelope" , mySession);
//            StartSessionResult = object.getJSONObject("soap:Body").getJSONObject("DeleteSpeakerResponse");
//			}
