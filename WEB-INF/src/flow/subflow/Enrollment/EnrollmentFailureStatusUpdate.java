...
public class EnrollmentFailureStatusUpdate extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-updateQR", "Default");
		next.setDebugId(88);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.getVariableField(IProjectVariables.VBREASON).setValue("TERMS AND CONDITIONS REJECTED");
		...
		vbhistory.setVC_FUNCTION_NAME("CONSENT_REJECT");
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivr consent reject status update i ivr db  \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	}
