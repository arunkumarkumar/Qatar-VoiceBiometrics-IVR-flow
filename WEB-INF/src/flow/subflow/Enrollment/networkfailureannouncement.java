 ...
 */
public class networkfailureannouncement extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2023-DEC-26  09:58:05 AM
	 */
	public networkfailureannouncement() {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Enrollment-UPDATEIVRDB_FAILURE");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-29  10:23:39 AM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try 
		{
			...
			mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "********* exitpoint ********* : "+exitpoint);
				...
				promptName = "ENROLLFAILURE_HOSTDOWN";
	...
	public void requestBegin(SCESession mySession) {
		//VBREASON
		mySession.getVariableField(IProjectVariables.VBREASON).setValue("NETWORK ISSUE");
