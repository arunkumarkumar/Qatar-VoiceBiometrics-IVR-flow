 ...
 * Last generated by Orchestration Designer at: 2024-JAN-23  02:49:58 PM
 */
public class noinputannounce extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Enrollment-enrollVoicePc");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-29  10:23:40 AM
	 */
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try 
		{
			...
			if("verify".equalsIgnoreCase(exitpoint)) {
				promptName = "VERIFYRETRY";
			}else {
				promptName = "VERIFYRETRYMISMATCH";
			}
