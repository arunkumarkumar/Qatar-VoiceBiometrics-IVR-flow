...
public class updateQR extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-TriggerSMS_and_email", "Default");
		next.setDebugId(93);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_CONSENT_DISAGREMENT_RJ_STATUS_UPDATE_IN_QR" + "|";
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivr consent reject status 'RJ' update in QR \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	}
