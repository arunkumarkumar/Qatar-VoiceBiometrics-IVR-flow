 ...
 * Last generated by Orchestration Designer at: 2023-DEC-22  12:38:16 PM
 */
public class consentMenu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("Agree", "1", true, "exact", "Enrollment-CONSENTUPDATEIVRDB", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Disagree", "2", true, "exact", "Enrollment-disagreeconsentannounce", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Repeat", "*", true, "exact", "Enrollment-repeatCheck", grammarInfo, true);
		list.add(choice);
	...
	public void updatePrompts(Collection prompts, SCESession mySession) {
		...
		try 
		{
			...
			promptFullyQualifiedPath= sudioPath +language+GlobalConstant.SEPARATOR_FORWARD_SLASH+promptName.trim()+GlobalConstant.EXTENSION_WAVE;
			phraseVarCounter = (phraseVarCounter+1);
			phraseVarName = GlobalConstant.VAR_COMPLEX_PHRASEVAR+GlobalConstant.SEPARATOR_COLON+GlobalConstant.VAR_COMPLEX_PHRASEVAR_FIELD+(phraseVarCounter);
			...
			mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "********* repeat count ********* : "+
			mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_REPEAT__COUNT).getIntValue());
			if(mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_REPEAT__COUNT).getIntValue()<3) {
			//TO REPEAT
			promptName="REPEAT_MESSAGE_1";
			promptFullyQualifiedPath= sudioPath +language+GlobalConstant.SEPARATOR_FORWARD_SLASH+promptName.trim()+GlobalConstant.EXTENSION_WAVE;
			phraseVarCounter = (phraseVarCounter+1);
			phraseVarName = GlobalConstant.VAR_COMPLEX_PHRASEVAR+GlobalConstant.SEPARATOR_COLON+GlobalConstant.VAR_COMPLEX_PHRASEVAR_FIELD+(phraseVarCounter);
			...
			Speak.add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.VARIABLE_TEXT,phraseVarName, format));
				...
				mySession.getTraceOutput().writeln(ITraceInfo.TRACE_LEVEL_DEBUG, "********* repeat count ********* : "+
						mySession.getVariableField(IProjectVariables.RETRY,IProjectVariables.RETRY_FIELD_REPEAT__COUNT).getIntValue()+ " and it is more than 2 hence repeat is disabled ");
			}
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_CONSENT_MENU" + "|";
		CallHistory.put("VC_EXIT_LOCATION", "ENROLL_CONSENT_MENU");
