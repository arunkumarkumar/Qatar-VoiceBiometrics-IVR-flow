 ...
 */
public class SMS_EMAIL_SUCCESS extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-UPDATE_QR_SUCCESS", "Default");
		next.setDebugId(399);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		mySession.setProperty("VB_ENROLL_STATUS",GlobalConstant.RETURN_CODE_SUCCESS);
		...
		customerDetails.put(GlobalConstant.VB_Status, "EN");
		customerDetails.put(GlobalConstant.VB_Status_Date, new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()).toString());
		customerDetails.put(GlobalConstant.VB_Enrollment_Failed, "NO");
		...
		{
			customerDetails.put(GlobalConstant.VB_enrollment_status, "Enrolled Successfully through Agent Assisted");
		}
		else {
			customerDetails.put(GlobalConstant.VB_enrollment_status, "Enrolled Successfully through IVR");	
		}
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_DEBUG, "customerDetails from IVR after enrollment success : "+customerDetails.toString(),mySession);
	}
		catch(Exception e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "\t|\tExcepiton while sending sms or email after enrollment success \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
		}
