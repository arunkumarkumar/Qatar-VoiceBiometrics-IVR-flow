 ...
 * Last generated by Orchestration Designer at: 2024-JAN-23  04:10:11 PM
 */
public class UPDATEIVRDB_FAILURE extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-SMS_EMAIL_FAILURE", "Default");
		next.setDebugId(538);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		vbhistory.setVC_FUNCTION_NAME("ENROLL_FAILURE");
		...
		load.values(method, mySession);
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "\t|\tExcepiton while updating IVR DB for enrollment failure update \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
		}
