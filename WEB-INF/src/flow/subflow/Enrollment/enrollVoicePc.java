 ...
 * Last generated by Orchestration Designer at: 2021-JAN-29  02:14:42 PM
 */
public class enrollVoicePc extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Enrollment-enrollVB_1");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Record getRecord(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		record = new com.avaya.sce.runtime.Record("enrollVoicePc", true, "7s", true, "2s", false, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-29  10:23:37 AM
	 */
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_VOICE_COLLECTION" + "|";
		CallHistory.put("VC_EXIT_LOCATION", "ENROLL_VOICE_COLLECT");
		CallHistory.put("VC_MENU_DESCRIPTION", MenuDescription);
		}
		catch(Exception e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t menu history insertion during enrollment voice collection process \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
		}
