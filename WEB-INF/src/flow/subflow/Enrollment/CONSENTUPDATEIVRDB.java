 ...
 */
public class CONSENTUPDATEIVRDB extends com.avaya.sce.runtime.Data {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("Enrollment-StartSessin", "Default");
		next.setDebugId(117);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_ENROLLMENT_CONSENT_AGREED_UPDATE_IVR_DB" + "|";
		...
		vbhistory.setVC_VB_REASON("TERMS AND CONDITION ACCEPTED");
		vbhistory.setVC_FUNCTION_NAME("CONSENT_ACCEPT");
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivr consent status update in ivr db  \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	}
