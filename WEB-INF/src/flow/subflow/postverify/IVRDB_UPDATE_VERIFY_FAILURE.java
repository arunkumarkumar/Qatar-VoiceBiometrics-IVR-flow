 ...
 * Last generated by Orchestration Designer at: 2024-FEB-01  08:46:31 AM
 */
public class IVRDB_UPDATE_VERIFY_FAILURE extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2024-FEB-01  08:46:31 AM
	 */
	public IVRDB_UPDATE_VERIFY_FAILURE() {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("postverify-preTransfer", "Default");
		next.setDebugId(474);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		vbhistory.setVC_FUNCTION_NAME("VERIFY_FAILURE");
		...
		vbhistory.setVC_TRANSFERRED_BY_AGENT_ID(GlobalConstant.NA);//obtained from agent
		vbhistory.setVC_TRANSFERRED_BY_AGENT_ROLE(GlobalConstant.NA);//obtained from agent
		...
		TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t ivrupdateverify failure\t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	}
