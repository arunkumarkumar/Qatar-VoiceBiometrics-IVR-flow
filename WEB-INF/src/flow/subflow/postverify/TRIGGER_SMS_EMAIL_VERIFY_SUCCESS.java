 ...
 */
public class TRIGGER_SMS_EMAIL_VERIFY_SUCCESS extends com.avaya.sce.runtime.Data {
	 ...
	 * Last generated by Orchestration Designer at: 2023-DEC-27  02:37:31 PM
	 */
	public TRIGGER_SMS_EMAIL_VERIFY_SUCCESS() {
	...
	public com.avaya.sce.runtime.Next getNext(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Next next = new com.avaya.sce.runtime.Next("postverify-IVRDB_UPDATE_VERIFY_SUCCESS", "Default");
		next.setDebugId(333);
		return next;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_VERIFICATION_VOICE_COLLECTION_SUCCESS_SMS_EMAIL" + "|";
		...
		mySession.setProperty("VB_VERIFICATION_STATUS","SUCCESS");
		mySession.setProperty("VB_VERIFICATION_STATUS_DATE",StartDate);
		
		}
		catch(Exception e) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "Error\t|\t trigger sms email verify success \t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
