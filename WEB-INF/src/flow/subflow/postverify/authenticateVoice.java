 ...
 * Last generated by Orchestration Designer at: 2021-JAN-29  11:59:15 AM
 */
public class authenticateVoice extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("postverify-vbAuthenticate");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Record getRecord(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build events for the record item: "authenticateVoice"
		events = new java.util.ArrayList();

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("postverify-RetryCheck", 0, true, "", java.util.Arrays.asList(new com.avaya.sce.runtime.CaptureExpression[] {new com.avaya.sce.runtime.CaptureExpression("retry:noinput", "_avayaNoinputCounter")})));
		events.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (com.avaya.sce.runtime.PromptRefInfo[])eventPromptNames.toArray(new com.avaya.sce.runtime.PromptRefInfo[0]), new com.avaya.sce.runtime.Goto("postverify-vbAuthenticate", 0, true, "", java.util.Arrays.asList(new com.avaya.sce.runtime.CaptureExpression[] {new com.avaya.sce.runtime.CaptureExpression("retry:nomatch", "_avayaNomatchCounter")})));
		events.add(event);

		// create the record item
		record = new com.avaya.sce.runtime.Record("authenticateVoice", true, "7s", true, "2s", false, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**
	...
	public void requestBegin(SCESession mySession) {
		...
		MenuDescription += "VB_VERIFICATION_VOICE_COLLECTION" + "|";
		CallHistory.put("VC_EXIT_LOCATION", "VERIFY_VOICE_COLLECT");
