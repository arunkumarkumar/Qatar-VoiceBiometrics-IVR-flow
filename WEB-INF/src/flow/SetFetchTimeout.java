...
public class SetFetchTimeout extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("DynamicFetchNode");
		return submit;
	}
	/**
	...
	public void updateProperties(Collection properties, SCESession mySession) {
		...
		if(timeout==null || timeout.isEmpty() || "NA".equalsIgnoreCase(timeout)) {
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"\t|\tFetch Time out is not Set\t|\t",mySession);
		} else {
			com.avaya.sce.runtime.Property property = new com.avaya.sce.runtime.Property("fetchtimeout", (timeout+"s"));
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_INFO,"\t|\tFetch Timeout is set as\t|\t"+timeout,mySession);
