 ...
 * Last generated by Orchestration Designer at: 2024-MAR-15  05:21:55 PM
 */
public class resetValues extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("confidencelevel", ".0");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("sensitivity", ".0");
		list.add(property);
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-15  05:21:55 PM
	 */
