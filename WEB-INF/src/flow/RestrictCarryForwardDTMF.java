 ...
 * Last generated by Orchestration Designer at: 2022-MAR-08  04:29:24 PM
 */
public class RestrictCarryForwardDTMF extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 2022-MAR-08  04:29:24 PM
	 */
	public RestrictCarryForwardDTMF() {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("confidencelevel", "0.0");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("sensitivity", "0.0");
		list.add(property);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("DummyPrompt", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("PostPC");
		return submit;
	}
	/**
