 ...
 * Last generated by Orchestration Designer at: 2021-JUN-06  09:14:12 PM
 */
public class DynamicPC extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getProperties(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		property = new com.avaya.sce.runtime.Property("confidencelevel", "1.0");
		list.add(property);

		property = new com.avaya.sce.runtime.Property("sensitivity", "1.0");
		list.add(property);
	...
	public void updateProperties(Collection properties, SCESession mySession) {
		...
		try {
			...
			String interdigitTimeout = mySession.getVariableField("ApplicationVariable", "InterDigitTimeOut").getStringValue();
			String isPrivate = mySession.getVariableField("ApplicationVariable", "IsPrivate").getStringValue();
			String terminatingChar = mySession.getVariableField("ApplicationVariable", "Termchar").getStringValue();

			if(!interdigitTimeout.equalsIgnoreCase("NA")) {
				property = new com.avaya.sce.runtime.Property("interdigittimeout", interdigitTimeout+"s");
				properties.add(property);
			}
			if(!isPrivate.equalsIgnoreCase("NA")) {
				property = new com.avaya.sce.runtime.Property("private", isPrivate);
				properties.add(property);
			}
			if(!terminatingChar.equalsIgnoreCase("NA")) {
				property = new com.avaya.sce.runtime.Property("termchar", terminatingChar);
				properties.add(property);
			}
			...
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "DynamicPC\t|\tupdateProperties\t|\t"+ AppConstants.EXCEPTION_1+ e.getMessage() +AppConstants.EXCEPTION_2 , mySession);
			TraceInfo.trace(ITraceInfo.TRACE_LEVEL_ERROR, "DynamicPC\t|\tupdateProperties\t|\t"+ Arrays.toString(e.getStackTrace()), mySession);
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		promptNames.add(new com.avaya.sce.runtime.PromptRefInfo("DynamicPrompt", ""));

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("DynamicGrammar", "1.0"));


		// build events for the field: "DynamicPC"
		...
		nbest = 1;
		field = new com.avaya.sce.runtime.Field("DynamicPC", false, true, grammarInfo, promptNames, events, properties, nbest, false, false, com.avaya.sce.runtimecommon.SCERT.RECTARG_BODYTEXT_GEN);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("RestrictCarryForwardDTMF");
		return submit;
	}
	/**
	 ...
	 * by the code generator based on items in the call flow editor.
	 * This method should not be manually edited as changes may be
	 * overwritten by the code generator.  <br>Last generated by Orchestration Designer at: 2024-MAR-29  10:23:42 AM
	 */
